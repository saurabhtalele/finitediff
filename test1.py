...
#total number of points in cosideration    
    ...
    put_text('take limits from 0 to 3 for example ,so points in cosiderations are 0,1,2,3 total n is 4')
...
#take limits from -3 to 3 for example ,so points in cosiderations are -3,-2,-1,0,1,2,3 total n is 7
    ...
    put_text('please provide only integer number ')
    put_text('stencil of 0 to 3 for example ,so points in cosiderations are 0,1,2,3 so min_limit as 0')
    min_limit = 0
    put_html('<hr>')
    put_text('stencil of 0 to 3 for example ,so points in cosiderations are 0,1,2,3 so max_limit as 3')
